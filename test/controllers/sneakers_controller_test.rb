...
class SneakersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sneaker" do
    assert_difference('Sneaker.count') do
      post sneakers_url, params: { sneaker: { brand: @sneaker.brand, model: @sneaker.model, year: @sneaker.year } }
    end
  ...
  test "should update sneaker" do
    patch sneaker_url(@sneaker), params: { sneaker: { brand: @sneaker.brand, model: @sneaker.model, year: @sneaker.year } }
